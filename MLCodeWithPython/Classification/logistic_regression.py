...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 12 11:15:54 2018

@author: Venkata Kiran Menda
"""

# Logistic Regression
# Problem : Identify the person is going to buy a car with respect to salary
# Matrix should be between age and Estimate salary and decision to be purchased columns only
# 0 means NO and 1 means YES in buying the car
#Importing a Library
